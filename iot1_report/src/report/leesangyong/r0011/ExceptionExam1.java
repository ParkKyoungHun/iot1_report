...
public class ExceptionExam1 extends Exception {
 ...
 */
	...
	public static void main(String[]args){
		...
		}catch(Exception e){							//try catch문에서 에러가 나면 그안의 코드는 실행안함
			System.out.println("숫자를 입력해야지!!!"); // 건너뜀
		}finally{} // 에러가 나든 안나든 무조건 실행됨.
